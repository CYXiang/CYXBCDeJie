...
- (void)setUpAllChildViewControllers{
    ...
    // 添加第四个子控制器
    [self setUpOneViewController:[[CYXNavigationController alloc]initWithRootViewController:[[CYXMeController alloc]initWithStyle:UITableViewStyleGrouped]]  title:@"我" image:@"tabBar_me_icon" selectImage:@"tabBar_me_click_icon"];
